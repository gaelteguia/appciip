...
/**
 * Servlet implementation class SupprimerAdresseService
 */
@SuppressWarnings("unchecked")
@WebServlet("/SupprimerAdresseService")
public class SupprimerAdresseService extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/ModifierAdresse.jsp";
	public static final String VUE_FORM = "/WEB-INF/ModifierAdresse.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Adresse localisation = form.consulterAdresse(request);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Adresse localisation = form.supprimerService(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			localisations.put(localisation.getId(), localisation);

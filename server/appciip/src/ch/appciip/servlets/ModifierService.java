...
public class ModifierService extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/ConsulterService.jsp";
	public static final String VUE_FORM = "/WEB-INF/ModifierService.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Service service = form.consulterService(request);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Service service = form.modifierService(request);

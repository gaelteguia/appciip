...
public class CreerAdresse extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/AssocierAdresseService.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Adresse localisation = form.creerAdresse(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			// Map<Long, Adresse> localisations = (TreeMap<Long,
			// Adresse>) session
			// .getAttribute(SESSION_LOCALISATIONS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */

...
public class AssocierCollaborateurComite extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/ConsulterFonction.jsp";
	public static final String VUE_FORM = "/WEB-INF/AssocierFonctionComite.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Fonction metier = form.associerComite(request);

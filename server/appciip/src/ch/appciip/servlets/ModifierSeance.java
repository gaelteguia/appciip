...
public class ModifierSeance extends HttpServlet {
	...
	public static final String ATT_DROIT = "droit";
	...
	public static final String VUE_SUCCES = "/WEB-INF/ConsulterSeance.jsp";
	public static final String VUE_FORM = "/WEB-INF/ModifierSeance.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Seance droit = form.consulterSeance(request);

		/* Ajout du bean et de l'objet m�tier � l'objet requ�te */
		request.setAttribute(ATT_DROIT, droit);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Seance droit = form.modifierSeance(request);
		...
		if (form.getErreurs().isEmpty()) {
			/* R�cup�ration de la session depuis la requ�te */
			HttpSession session = request.getSession(true);
			Map<Long, Seance> droits = (TreeMap<Long, Seance>) session.getAttribute(SESSION_DROITS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (droits == null) {
				droits = new TreeMap<Long, Seance>();
			}
			/* Puis ajout de la commande courante dans la map */
			// droits.put(droit.getId(), droit);

...
/**
 * Servlet implementation class SupprimerComiteSeance
 */
@SuppressWarnings("unchecked")
@WebServlet("/SupprimerComiteSeance")
public class SupprimerComiteSeance extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/ModifierComite.jsp";
	public static final String VUE_FORM = "/WEB-INF/ModifierComite.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Localisation profil = form.consulterComite(request);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Localisation profil = form.supprimerSeance(request);
		...
		if (form.getErreurs().isEmpty()) {
			/* R�cup�ration de la session depuis la requ�te */
			HttpSession session = request.getSession(true);
			Map<Long, Localisation> profils = (TreeMap<Long, Localisation>) session.getAttribute(SESSION_PROFILS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (profils == null) {
				profils = new TreeMap<Long, Localisation>();
			}

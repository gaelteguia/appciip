...
public class ConsulterDirective extends HttpServlet {
	/**
	 * 
	 */
	...
	public void init() throws ServletException {
		...
		this.p = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getDirectiveManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		DirectiveForm form = new DirectiveForm(p);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Directive compteRendu = form.consulterDirective(request);

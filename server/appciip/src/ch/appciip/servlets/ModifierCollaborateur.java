...
public class ModifierCollaborateur extends HttpServlet {
	...
	public static final String VUE_FORM = "/WEB-INF/ModifierCollaborateur.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Utilisateur utilisateur = form.consulterCollaborateur(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			// Map<Long, Collaborateur> utilisateurs = (TreeMap<Long,
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Utilisateur utilisateur = form.modifierCollaborateur(request, chemin);
		...
		if (form.getErreurs().isEmpty()) {
			...
			utilisateurs.put(utilisateur.getSuperviseur().getId(), utilisateur.getSuperviseur());
			/* Et enfin (r�)enregistrement de la map en session */
			session.setAttribute(SESSION_UTILISATEURS, utilisateurs);

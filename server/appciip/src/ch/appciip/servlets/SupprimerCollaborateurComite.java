...
/**
 * Servlet implementation class SupprimerFonctionComite
 */
@SuppressWarnings("unchecked")
@WebServlet("/SupprimerFonctionComite")
public class SupprimerCollaborateurComite extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/ModifierFonction.jsp";
	public static final String VUE_FORM = "/WEB-INF/ModifierFonction.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Fonction metier = form.consulterFonction(request);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Fonction metier = form.supprimerComite(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			metiers.put(metier.getId(), metier);

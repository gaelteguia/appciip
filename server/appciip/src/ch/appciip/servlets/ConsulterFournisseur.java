...
public class ConsulterFournisseur extends HttpServlet {
	/**
	 * 
	 */
	...
	public void init() throws ServletException {
		...
		this.m = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getFournisseurManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		FournisseurForm form = new FournisseurForm(u, a, d, l, m, n, p, s);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Fournisseur metier = form.consulterFournisseur(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			/* Ensuite r�cup�ration de la map dans la session */
			Map<Long, Fournisseur> metiers = (TreeMap<Long, Fournisseur>) session.getAttribute(SESSION_METIERS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (metiers == null) {
				metiers = new TreeMap<Long, Fournisseur>();
			}

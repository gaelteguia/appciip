...
public class ConsulterBreve extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String ATT_BREVE = "breve";
	public static final String ATT_FORM = "form";
	public static final String ATT_SESSION_USER = "sessionCollaborateur";

	public static final String BREVE_UTILISATEURS = "initCollaborateurs";
	public static final String BREVE_SERVICES = "initServices";
	...
	public static final String VUE_SUCCES = "/WEB-INF/breve.jsp";
	public static final String VUE_FORM = "/WEB-INF/breve.jsp";

	private CollaborateurManager u;
	private BreveManager a;
	...
	public void init() throws ServletException {
		...
		this.a = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getBreveManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		BreveForm form = new BreveForm(a);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Breve breve = form.consulterBreve(request);

		/* Ajout du bean et de l'objet m�tier � l'objet requ�te */
		request.setAttribute(ATT_BREVE, breve);

...
public class ConsulterCompteRendu extends HttpServlet {
	/**
	 * 
	 */
	...
	public void init() throws ServletException {
		...
		this.p = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getCompteRenduManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		CompteRenduForm form = new CompteRenduForm(p);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		CompteRendu compteRendu = form.consulterCompteRendu(request);

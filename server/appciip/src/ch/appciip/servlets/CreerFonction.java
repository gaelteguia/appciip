...
public class CreerFonction extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_FORM = "/WEB-INF/CreerFonction.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Fonction metier = form.creerFonction(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			services.put(metier.getService().getId(), metier.getService());
			/* Et enfin (r�)enregistrement de la map en session */
			...
			/* Ensuite r�cup�ration de la map des commandes dans la session */
			// Map<Long, Fonction> metiers = (TreeMap<Long, Fonction>) session
			// .getAttribute(SESSION_METIERS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			// if (metiers == null) {

...
public class Meteo implements Serializable {
	...
	public Meteo(Long id, String numero, BigDecimal prix, Utilisateur contactInterne, Fournisseur fournisseur) {
		this.id = id;
		this.numero = numero;
		this.prix = prix;
	...
	public Meteo(Long id) {
		this.id = id;
	}

	public Meteo(Long id, String numero, BigDecimal prix) {
		this.id = id;
		this.numero = numero;
		this.prix = prix;
	}

	public Meteo(String numero) {
		this.numero = numero;
	}

	public Meteo(Long id, String numero, BigDecimal prix, Utilisateur contactInterne) {
		this.id = id;
		this.numero = numero;
		this.prix = prix;
		this.contactInterne = contactInterne;

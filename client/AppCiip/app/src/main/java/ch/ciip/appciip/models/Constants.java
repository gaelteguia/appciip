...
public final class Constants {
    ...
    public static final String RESULT_DATA_ID = PACKAGE_NAME + ".RESULT_DATA_ID";
    ...
    public static final String LOCATION_ID_DATA_EXTRA = PACKAGE_NAME + ".LOCATION_ID_DATA_EXTRA";

    public static final String FETCH_TYPE_EXTRA = PACKAGE_NAME + ".FETCH_TYPE_EXTRA";

    public static final String API_BASE_URL = "http://83.68.194.220:8080/appciip/";

...
public class CreerSeance extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String VUE_SUCCES = "/WEB-INF/AssocierComiteSeance.jsp";
	public static final String VUE_FORM = "/WEB-INF/CreerSeance.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Seance droit = form.creerSeance(request);

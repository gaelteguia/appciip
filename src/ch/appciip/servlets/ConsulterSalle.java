...
public class ConsulterSalle extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String SESSION_SALLES = "salles";
	...
	public static final String VUE_SUCCES = "/WEB-INF/salle.jsp";
	public static final String VUE_FORM = "/WEB-INF/salle.jsp";

	private CollaborateurManager u;
	private ApplicationManager a;
	private SeanceManager d;
	private AdresseManager l;
	private SalleManager m;
	...
	public void init() throws ServletException {
		...
		this.m = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getSalleManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		SalleForm form = new SalleForm(m);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Salle salle = form.consulterSalle(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			/* Ensuite r�cup�ration de la map dans la session */
			Map<Long, Salle> salles = (TreeMap<Long, Salle>) session.getAttribute(SESSION_SALLES);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (salles == null) {
				salles = new TreeMap<Long, Salle>();
			}

			/* Et enfin (r�)enregistrement de la map en session */
			session.setAttribute(SESSION_SALLES, salles);

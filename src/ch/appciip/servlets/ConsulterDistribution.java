...
public class ConsulterDistribution extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String ATT_COMPTE_RENDU = "compteRendu";
	...
	public static final String VUE_SUCCES = "/WEB-INF/compte_rendu.jsp";
	public static final String VUE_FORM = "/WEB-INF/compte_rendu.jsp";
	...
	public void init() throws ServletException {
		...
		this.p = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getDistributionManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		DistributionForm form = new DistributionForm(p);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Distribution compteRendu = form.consulterDistribution(request);

		/* Ajout du bean et de l'objet m�tier � l'objet requ�te */
		request.setAttribute(ATT_COMPTE_RENDU, compteRendu);

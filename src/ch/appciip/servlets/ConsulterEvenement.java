...
public class ConsulterEvenement extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String ATT_EVENEMENT = "evenement";
	...
	public static final String VUE_SUCCES = "/WEB-INF/evenement.jsp";
	public static final String VUE_FORM = "/WEB-INF/evenement.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Evenement evenement = form.consulterEvenement(request);

		/* Ajout du bean et de l'objet m�tier � l'objet requ�te */
		request.setAttribute(ATT_EVENEMENT, evenement);

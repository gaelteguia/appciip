...
public class ConsulterPartenaire extends HttpServlet {
	/**
	 * 
	 */
	...
	public void init() throws ServletException {
		...
		this.m = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getPartenaireManager();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PartenaireForm form = new PartenaireForm(m);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Partenaire metier = form.consulterPartenaire(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			/* Ensuite r�cup�ration de la map dans la session */
			Map<Long, Partenaire> metiers = (TreeMap<Long, Partenaire>) session.getAttribute(SESSION_METIERS);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (metiers == null) {
				metiers = new TreeMap<Long, Partenaire>();
			}

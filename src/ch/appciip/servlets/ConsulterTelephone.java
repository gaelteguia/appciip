...
public class ConsulterTelephone extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String APPLICATION_SERVICES = "initTelephones";
	...
	public void init() throws ServletException {
		...
		this.s = ((Factory) getServletContext().getAttribute(CONF_FACTORY)).getTelephoneManager();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		TelephoneForm form = new TelephoneForm(s);

		/* Traitement de la requ�te et r�cup�ration du bean en r�sultant */
		Telephone service = form.consulterTelephone(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			Map<Long, Telephone> services = (TreeMap<Long, Telephone>) session.getAttribute(SESSION_SERVICES);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (services == null) {
				services = new TreeMap<Long, Telephone>();
			}

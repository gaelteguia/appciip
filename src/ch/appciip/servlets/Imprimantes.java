...
/**
 * Servlet implementation class Imprimantes
 */
@WebServlet("/imprimantes")
public class Imprimantes extends HttpServlet {
	/**
	 * 
	 */
	...
	public static final String SESSION_ADRESSES = "imprimantes";
	...
	public static final String VUE_SUCCES = "/WEB-INF/imprimantes.jsp";
	public static final String VUE_FORM = "/WEB-INF/imprimantes.jsp";

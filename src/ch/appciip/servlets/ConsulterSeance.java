...
public class ConsulterSeance extends HttpServlet {
	...
	public static final String SESSION_SEANCES = "seances";
	...
	public static final String VUE_SUCCES = "/WEB-INF/seance.jsp";
	public static final String VUE_FORM = "/WEB-INF/seance.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Seance seance = form.consulterSeance(request);
		...
		if (form.getErreurs().isEmpty()) {
			...
			/* Ensuite r�cup�ration de la map des commandes dans la session */
			Map<Long, Seance> seances = (TreeMap<Long, Seance>) session.getAttribute(SESSION_SEANCES);
			/*
			 * Si aucune map n'existe, alors initialisation d'une nouvelle map
			 */
			if (seances == null) {
				seances = new TreeMap<Long, Seance>();
			}

			/* Et enfin (r�)enregistrement de la map en session */
			session.setAttribute(SESSION_SEANCES, seances);
